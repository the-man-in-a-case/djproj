...
def demo():
    ...
    (Path("generated") / "unified.json").write_text(json.dumps(unified, ensure_ascii=False, indent=2), encoding="utf-8")

    # render all to /mnt/data/unified_factory/generated_out
    render_dir = render_all(unified, "generated_out", "templates")
